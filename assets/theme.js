   ...
   */
      ...
      var ProductVariants = function () {
        ...
        _createClass(ProductVariants, [{
          ...
          value: function _attachListeners() {
            ...
            this.delegateElement.on('click', '.ProductForm__Option [type="radio"]', this._onOptionChanged.bind(this));
          }
       ...
       */
          ...
          value: function _onVariantChanged(previousVariant, newVariant) {
            ...
            // 7th: Change Inventory Text
            let variantOptions = document.querySelectorAll("select[name='id'] option");
            for(let i = 0; i < variantOptions.length; i++){
              let dataTitle = variantOptions[i].dataset.title.trim();
              //  if (newVariant !== null && newVariant !== undefined) {
              //alert("test");
              let variantTitle = newVariant.title.trim()
              if(newVariant){
                if(variantTitle == dataTitle){
                  if(variantOptions[i].dataset.inventoryText){
                    //alert('test');
                    document.querySelector("#variant-inventory").innerHTML = `<p>${variantOptions[i].dataset.inventoryText}</p>`;
                  }
                }
              }
              //  }  
...
//             console.log("New variant selected", newValue);
       ...
       */
          ...
          value: function _addToCart(event) {
            ...
            var formData = {};
            let serializeData = __WEBPACK_IMPORTED_MODULE_2__helper_Form__["default"].serialize(formElement);
            let NewFormData = {};
            let EngravedRadio = $("#engraving_checkbox").length;
            let isEngravedChecked = $("#engraving_checkbox").is(":checked");
            let mainProductId = serializeData.id;
            function themeAddToCart(timestamp){
              let mainProductProperties = serializeData.properties;
              if(timestamp){
                mainProductProperties["timeStamp"] = timestamp;
              }
              formData["items"] ={
                "items":[
                  {
              ...
              .then(function (response) {
                ...
                if (response.ok) {
                  addToCartButton.removeAttribute('disabled');
                  // console.log("Here", _this7.currentVariant);
    ...
    /***/function (module, __webpack_exports__, __webpack_require__) {
       ...
       */
          ...
          value: function _initPhotoSwipe() {
            var images = [];
            this.slideshow = Flickity.data($('.Product__Slideshow')[0]);
            console.log(this.slideshow);
            this.slideshow.cells.forEach(function (item) {
              if (item.element.classList.contains('Product__SlideItem--image')) {
                images.push(item.element.querySelector('img'));
              }
            });
            console.log("Here...")
            this._createPhotoSwipeInstance(this._createPhotoSwipeItemsFromImages(images), parseInt(this.slideshow.selectedElement.getAttribute('data-image-media-position')));
          }
       ...
       */
          ...
          value: function _initPhotoSwipeFromImageClick(event, target) {
            ...
            console.log(this.element.querySelectorAll('.Product__Slideshow .Product__SlideItem--image img'))
            var images = __WEBPACK_IMPORTED_MODULE_0__helper_Dom__["default"].nodeListToArray(this.element.querySelectorAll('.Product__Slideshow .Product__SlideItem--image img'));
            console.log("Here->",target.getAttribute('data-image-media-position'))
       ...
       */
          ...
          value: function _createPhotoSwipeInstance(items, selectedImageIndex) {
            ...
            this.photoSwipeInstance = new PhotoSwipe(photoswipeContainer, false, items, {
              ...
              getThumbBoundsFn: function getThumbBoundsFn(selectedImageIndex) {
                console.log("Index",selectedImageIndex)
                var thumbnail = _this10.element.querySelector('.Product__SlideItem[data-image-media-position="' + parseInt(selectedImageIndex) + '"] img'),
...
// We have some listeners that are specific to the fact it's a drawer or the dedicated cart page
      ...
      var CollectionSection = function () {
        ...
        _createClass(CollectionSection, [{
          ...
          value: function _resetTags() {
            ...
            filterElement.innerHTML += '<span class="Text--subdued"><span class="symbol">+</span></span>';
          ...
          value: function _reloadProducts() {
            ...
            if (filterElement) {
              ...
              if (this.currentTags.length === 0) {
                ...
                filterElement.innerHTML += '<span class="Text--subdued">(' + this.currentTags.length + ')<span class="symbol">+</span></span>';
              }
            }
            ...
            fetch(location.pathname + '?view=ajax&sort_by=' + this.currentSortBy, {
              ...
              response.text().then(function (content) {
                ...
                var elementOffset = ""
                if(_this44.element.querySelector('.CollectionMain')){
                  elementOffset = _this44.element.querySelector('.CollectionMain').getBoundingClientRect().top - parseInt(document.documentElement.style.getPropertyValue('--header-height'));
                }else{
                  elementOffset = _this44.element.querySelector('.CollectionMain2').getBoundingClientRect().top - parseInt(document.documentElement.style.getPropertyValue('--header-height'));
                }
    ...
    /***/function (module, __webpack_exports__, __webpack_require__) {
      ...
      var NewsletterPopupSection = function () {
        function NewsletterPopupSection(element) {
          ...
          this.delegateElement = new domDelegate.Delegate(this.element);
          this.options = JSON.parse(element.getAttribute('data-section-settings'));
          this.form = document.querySelector("#newsletter-popup");
          this.form.addEventListener("submit", this._onNewsLetterSubmit);
        ...
        _createClass(NewsletterPopupSection, [{
          ...
          key: '_onNewsLetterSubmit',
          value:function _onNewsLetterSubmit(event){
          	console.log(event);
            event.preventDefault();
          }
        }]);
          ...
          value: function _loadRecommendations() {
            ...
            return fetch(url).then(function (response) {
              return response.text().then(function (content) {
                ...
                if(_this57.element.querySelector('.ProductRecommendations')){
  ...
  /******/);
$('form.Footer__Newsletter.Form').submit( function(e){
  e.preventDefault();
